...
<html lang="en">
    <head>
        ...
        <title>Donations | The Hull Seals</title>
    ...
    <body>
        <div id="home">
            ...
            <section class="introduction">
                <article>
                    <h1>Success</h1>
					<h5 class="text-success">Thank you for generous donation, Seal!<br /><br /> You may now close the tab.<br /><br /> If you do not receive a confirmation email soon, please contact us.</h5>
                </article>
            </section>
        </div>
